...
$("#calculate-rate").on("click", function (event) {
    ...
    $("#business-overhead-text").html("<b>Expenses: </b> $" + costSum.toFixed(2));
    ...
    $("#second-overhead").html("<b>Expenses: </b> $" + overhead.toFixed(2));
    ...
    $("#pocket-overhead").html("<b>In Pocket + Overhead: </b> $" + costAll.toFixed(2));
    ...
    $("#inc-required").html("<b>Income Required: </b> $" + incRequired.toFixed(2));

    // Final Spot
    hoursWorked = parseInt(document.getElementById("hours-worked").value);
    hourlyRate = incRequired / hoursWorked;
    $("#hourly-rate").html("<b>Hourly Rate: </b> $" + hourlyRate.toFixed(2));
